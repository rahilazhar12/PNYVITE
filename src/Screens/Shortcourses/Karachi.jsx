...
const Karachi = () => {
  ...
  useEffect(() => {
    const fetchCourses = async () => {
      setIsLoading(true);
      try {
        const response = await axios.get(`https://www.admin786.pnytrainings.com/api/shortcourse/short-courses-in-karachi`);
          ...
          return (
            <>
              <Helmet>
                ...
                <link rel="canonical" href={`http://localhost:3000/short-courses-in-karachi`} />
              </Helmet>
            </>
          )
        })
