    ...
    const fetchdatacitywise = async () => {
      ...
      try {
        let response = await axios.get(
          `https://www.admin786.pnytrainings.com/api/city/specialpage/${'amazon-dropshipping-training-course-in-lahore-pakistan'}`
        );
...
export default Amazondropshipping;
