    ...
    const fetchdatacitywise = async () => {
      ...
      try {
        let response = await axios.get(
          `https://www.admin786.pnytrainings.com/api/city/specialpage/${'pny-trainings-in-multan-empowring-professional-skills'}`
        );
...
export default EmpowringProfessional;
